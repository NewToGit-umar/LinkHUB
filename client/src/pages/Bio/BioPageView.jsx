    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-500">{error || 'The bio page you're looking for doesn't exist.'}</p>
        </div>
      </div>
    )
  }
            ...
            .map((link) => (
              <a
                ...
                style={{
                  ...
                  border: styles.buttonStyle === 'outlined' ? `2px solid ${styles.linkColor || '#3b82f6'}` : 'none',
                  background: styles.buttonStyle === 'ghost' ? 'transparent' : styles.linkBackgroundColor
                }}
              >
